...
var ExerciseCompleted = 'Challenge\'s over!';
...
I[0][2]='1';
I[0][3]=new Array();
I[0][3][0]=new Array('brunneus','',1,100,0);
I[0][3][1]=new Array('emarginatus','Orange head. In Corsica and south of France, some are totaly black.<br/>',1,100,0);
I[0][3][2]=new Array('bruneus','Pay attention to the spelling !<br/>',0,0,1);
I[0][3][3]=new Array('emmarginatus','Pay attention to the spelling !<br/>',0,0,1);
I[1]=new Array();I[1][0]=100;
I[1][1]='';
I[1][2]='1';
I[1][3]=new Array();
I[1][3][0]=new Array('Chthonolasius','',1,100,1);
I[1][3][1]=new Array('Austrolasius','',1,100,1);
I[1][3][2]=new Array('Cautolasius','',1,100,1);
I[1][3][3]=new Array('Chtonolasius','No bad... Pay attention to the spelling !<br/>',0,0,1);
I[1][3][4]=new Array('Ostrolasius','Pay attention to the spelling !<br/>',0,0,1);
I[1][3][5]=new Array('Ostraulasius','Dude ! Pay attention to the spelling !<br/>',0,0,1);
I[1][3][6]=new Array('Austraulasius','Dude ! Pay attention to the spelling !<br/>',0,0,1);
I[1][3][7]=new Array('Ctonolasius','Dude ! Pay attention to the spelling !<br/>',0,0,1);
I[1][3][8]=new Array('Cthonolasius','Dude ! Pay attention to the spelling !<br/>',0,0,1);
I[2]=new Array();I[2][0]=100;
I[2][1]='';
I[2][2]='0';
I[2][3]=new Array();
I[2][3][0]=new Array('yes','',1,100,1);
I[2][3][1]=new Array('no','Some are dark brown... it\'s still dark...',0,0,1);
I[2][3][2]=new Array('hummm....','',0,0,1);
I[3]=new Array();I[3][0]=100;
I[3][1]='';
I[3][2]='1';
I[3][3]=new Array();
I[3][3][0]=new Array('orange','',1,100,1);
I[3][3][1]=new Array('yellow','Not exactly... Although \'citrinus\' means lemon.',0,0,1);
I[3][3][2]=new Array('black','Black ? Do you know what \'citrinus\' means ?',0,0,1);
I[4]=new Array();I[4][0]=100;
I[4][1]='';
I[4][2]='1';
I[4][3]=new Array();
I[4][3][0]=new Array('yellow','',1,100,1);
I[4][3][1]=new Array('orange','',1,100,1);
